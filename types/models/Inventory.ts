...
export type TInventory = Prisma.InventoryGetPayload<{select: Settings['selects']['inventory']}>;

export type TInventoryField = Omit<Prisma.InventoryFieldGetPayload<true>, 'inventoryId'>;
...
export type TUpdateInventoryData = Partial<IInventoryData> & Required<Pick<IInventoryData, 'version'>>;

export type TInventoryData = Partial<Omit<IInventoryData, 'version'>> & Required<Pick<IInventoryData, 'version'>>
...
export type TCustomIdPartFormat = EnumCustomIdPartFormatDigit | EnumCustomIdPartFormatHex | EnumCustomIdPartFormatDateTime | string | null;
...
export interface IInventoryModel {
    ...
    getAll(sortOrder?: EnumInventorySortOrder, ownerId?: number, allowedUserId?: number, isPublic?: boolean): Promise<TInventory[]>;
    create(data: TInventoryCreateData): Promise<TInventory>;
    updateById(id: number, data: TInventoryUpdateData, version: number,): Promise<TInventory>;
