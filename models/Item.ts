...
import type { IItemModel, TItem, TItemCreateData, TItemUpdateData, TLike } from '../types/models/Item.js';
...
export default class ItemModel extends Model<TItem, TItemCreateData, TItemUpdateData> implements IItemModel {
    ...
    async create(data: TItemCreateData, customIdFormatParts: ICustomIdFormatPart[]): Promise<TItem> {
        return await prisma.$transaction(async(tx) => {
            data.customId = await this.IdGenerator.generateCustomId(customIdFormatParts, tx);
