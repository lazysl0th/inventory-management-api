...
export default class UserRoleModel implements IUserRoleModel {
    ...
    async createUsersRoles (userRoleIds: TUserRole[]): Promise<Prisma.BatchPayload> {
    ...
    async deleteUsersRoles (userIds: number[], roleIds: number[]): Promise<Prisma.BatchPayload> {
