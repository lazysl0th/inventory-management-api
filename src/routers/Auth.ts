...
export default class AuthRouter extends Router implements IAuthRouter {
  ...
  initializeRoutes(): void {
    this.router.post(
      "/signup",
      this.AuthValidator.registerUser(),
      this.AuthController.registerUser,
    );
    this.router.post(
      "/signin",
      this.AuthValidator.loginUserByEmail(),
      Passport.authorize("local"),
      this.AuthController.loginUserByEmail,
    );
    this.router.get(
      "/refreshAccessToken",
    ...
    this.router.get(
      ...
      this.AuthController.loginUserBySocials,
    );
    this.router.get(
      "/signin/facebook",
    ...
    this.router.post(
      "/resetPassword",
      this.AuthValidator.resetUserPassword(),
      this.AuthController.resetUserPassword,
    );
