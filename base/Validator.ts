import { celebrate, Joi, type CelebrateOptions, type SchemaOptions } from "celebrate";
...
export default abstract class Validator {
    ...
    protected numberArrayRequiredSchema = Joi.array().items(Joi.number().integer().positive()).required()
