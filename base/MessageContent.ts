...
import type { Content, ContentParams, MessageType, Params } from "../types/base/MessageContent.js";
...
export default abstract class MessageContent {
  ...
  static getContent(params?: ContentParams): Content {
    return {
      subject: params?.subject ? this._getSubject(params?.subject) : this._getSubject(),
