...
import type { ExtendedRequest, HandlerController } from "../types/base/Controller.js";
...
export abstract class Controller {
    protected handle<TParams={}, TBody={}, TQuery={}>(handler: HandlerController<TParams, TBody, TQuery>): Handler {
        ...
        if (e instanceof Prisma.PrismaClientKnownRequestError) {
            switch (e.code) {
                ...
                case 'P2025':
                    ...
                    break;
                default: err = new BadRequest(BAD_REQUEST.TEXT);
            }
    ...
    protected setCookie(res: Response, cookieName: string, cookieValue: string): void {
        res.cookie(cookieName, cookieValue, { httpOnly: true, secure: false, sameSite: 'strict', maxAge: 7 * 24 * 60 * 60 * 1000 });
    }
