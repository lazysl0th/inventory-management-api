...
import type { IEmailService, IEmailServiceOptions } from "../types/services/Email.js";
...
export default class EmailService implements IEmailService {
  ...
  constructor() {
    ...
    this.oAuth2Client = new google.auth.OAuth2(this.options.clientID, this.options.clientSecret, this.options.redirectURL);
    this.oAuth2Client.setCredentials({refresh_token: this.options.refreshToken});
  }
  ...
  async sendMessage (email: string, content: Content ): Promise<gmail_v1.Schema$Message> {
