...
export default class SalesForceRouter extends Router implements IBaseRouter {
    ...
    initializeRoutes(): void {
        ...
        this.router.get('/address', this.SalesForceController.getLocationFromSalesForce);
        this.router.post('/addInfo/:userId', this.IntegrationValidator.addAditionalInfo(), this.SalesForceController.addAdditionalInfoToSalesForce);
        this.router.post('/getInfo/:userId', this.IntegrationValidator.addAditionalInfo(), this.SalesForceController.getAdditionalInfoFromSalesForce);
    }
}