...
export default class UserRoleRouter extends Router implements IBaseRouter {
    ...
    initializeRoutes(): void {
        this.router.post('/', this.UserRoleValidator.changeRoles(), this.UserRoleController.addRoles);
        this.router.delete('/', this.UserRoleValidator.changeRoles(), this.UserRoleController.deleteRoles);
    }
}