...
export default class IntegrationRouter extends Router implements IIntegrationRouter {
    constructor(
    ...
    initializeRoutes(): void {
        this.router.post('/cloudinary', this.IntegrationController.multerSettingsUpload.single("image"), this.IntegrationController.uploadImageToCloudinary);
        this.router.post('/dropbox', this.IntegrationController.uploadJsonToDropbox);
